...
python -m tinker_cookbook.recipes.multi_agent_debate.train batch_size=1 num_train_datapoints=1 num_test_datapoints=0 eval_every=0 num_groups_to_log=1 max_rounds=4 num_agents=5 history_rounds=1 model_name="Qwen/Qwen3-8B" log_full_transcript=True